    ...
    <div className="bg-black min-h-screen flex flex-col md:gap-10">
      ...
      <div className="flex justify-center">
        ...
        >
          ...
          <h2 className="text-3xl font-bold text-yellow-300">Sign Up</h2>
          <label
          ...
          >
            Confirm Password
            <input
              className="border w-full rounded mt-1 py-1 px-2 text-black font-normal text-base focus:outline-none focus:ring focus:ring-yellow-400"
              type="password"
              name="password"
              placeholder=" "
              required
          ...
          <div className="mt-4 flex flex-col md:flex-row gap-3 md:gap-0 justify-between items-center w-full">
